            ...
            <div class="modal fade" id="change-info" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formChange" action="supportChange.php" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class = "mb-3">
                                    <label for="">Cập nhật ảnh nhân viên:</label>
                                    ...
                                    <input type = "hidden" value="<?php echo $id; ?>" name="id" id="supportID">
                                    <input type = "hidden" value="<?php echo $support['CCCD']; ?>" id="supportCCCD">
                                </div>
                                <div class="mb-3">
                            ...
                            CCCD = document.getElementById('supportCCCD').value
